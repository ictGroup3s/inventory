...
//	            @RequestParam("login_pass") String pw,
//	            HttpSession session
//	    ) {
//	        Member m = new Member(); //멤버테이블이름
//	        m.setUserId(id);
//	        m.setUserPw(pw);

//	        boolean result = loginService.login(m);  // 여기서 loginService 사용됨
...
//	    }
	...
	@GetMapping("detail_slider")
	public String detail_slider() {
