...
public class projectController {
	...
	/*
	 * @GetMapping("header") public String header() { return "header"; }
	 */
	@GetMapping("login")
	public String login() {
		return "login";
	...
	public String selectall(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
	...
	public String selectBanchan(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
	...
	public String selectSoup(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
			@RequestParam(value = "cate", required = false) Integer cate) {
	...
	public String selectGui(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
			@RequestParam(value = "cate", required = false) Integer cate) {
	...
	public String selectBunsik(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
			@RequestParam(value = "cate", required = false) Integer cate) {
	...
	public String selectDiet(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
			@RequestParam(value = "cate", required = false) Integer cate) {
	...
	public String selectdrink(Model m, @RequestParam(value = "page", required = false, defaultValue = "1") int page,
			@RequestParam(value = "size", required = false, defaultValue = "9") int size,
			@RequestParam(value = "q", required = false) String q,
			@RequestParam(value = "sort", required = false) String sort,
			@RequestParam(value = "cate", required = false) Integer cate) {
...
// 	통계 페이지(연도별*월별 매출 / 지출)	
	...
	public String stats(Model model) throws Exception {
		...
		int[][] sample = { { 2025, 11, 2630, 1870 }, { 2025, 10, 2350, 1530 }, { 2025, 9, 2080, 1350 },
				{ 2025, 8, 1660, 1060 }, { 2025, 7, 1630, 1240 }, { 2025, 6, 1750, 1270 }, { 2025, 5, 1820, 1210 } };
		for (int[] r : sample) {
		...
		String[] days = { "2024-11-11", "2024-11-10", "2024-11-09", "2024-11-08", "2024-11-07", "2024-11-06",
				"2024-11-05" };
		...
		int[][] mv = { { 2024, 11, 37200, 2100 }, { 2024, 10, 36000, 1980 }, { 2024, 9, 34500, 1850 },
				{ 2024, 8, 31000, 1720 }, { 2024, 7, 29800, 1680 }, { 2024, 6, 30500, 1740 },
				{ 2024, 5, 32000, 1820 } };
		for (int[] r : mv) {
		...
		monthly.sort((a, b) -> {
			int ay = (int) a.get("year");
			int am = (int) a.get("month");
			int by = (int) b.get("year");
			int bm = (int) b.get("month");
			if (ay != by)
				return Integer.compare(by, ay); // year desc
