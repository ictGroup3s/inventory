						...
						-->
							<div class="dropdown ml-4">
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item" href="selectdrink?page=1&size=${size}&q=${fn:escapeXml(q)}">최신순</a> 
									<a class="dropdown-item" href="selectdrink?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_desc">가격 높은순</a> 
									<a class="dropdown-item" href="selectdrink?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_asc">가격 낮은순</a>
								</div>
							</div>
						</div>
					</div>
						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center mb-3">
								<li class="page-item ${page <= 1 ? 'disabled' : ''}">
									<a class="page-link" href="selectdrink?page=${page-1}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}" aria-label="Previous">
								...
								<c:forEach var="i" begin="1" end="${totalPages}">
									<li class="page-item ${i == page ? 'active' : ''}">
										<a class="page-link" href="selectdrink?page=${i}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}">${i}</a>
									</li>
								</c:forEach>
								<li class="page-item ${page >= totalPages ? 'disabled' : ''}">
									<a class="page-link" href="selectdrink?page=${page+1}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}" aria-label="Next">
