			...
			<div class="col-lg-2">
				...
				<nav class="category-sidebar" style="margin-left: -80px;">
					...
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a href="selectGui"
							class="nav-link active">구이 ．찜 ．볶음</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item"
										href="selectGui?page=1&size=${size}&q=${fn:escapeXml(q)}">최신순</a>
									<a class="dropdown-item"
										href="selectGui?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_desc">가격
										높은순</a> <a class="dropdown-item"
										href="selectGui?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_asc">가격
										낮은순</a>
								</div>
							</div>
						</div>
							...
							<ul class="pagination justify-content-center mb-3">
								...
								<c:forEach var="i" begin="1" end="${totalPages}">
									<li class="page-item ${i == page ? 'active' : ''}"><a
										class="page-link"
										href="selectGui?page=${i}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}">${i}</a>
									</li>
								</c:forEach>
