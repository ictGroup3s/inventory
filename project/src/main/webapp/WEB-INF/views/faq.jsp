...
<c:forEach var="b" items="${list}" varStatus="st">
    <div class="card mb-2">
        <div class="card-header" id="heading${b.board_no}">
            <h6 class="mb-0 d-flex justify-content-between align-items-center">
                <button class="btn btn-link text-left" type="button"
                        ...
                        data-target="#collapse${b.board_no}"
                        aria-expanded="false"
                        aria-controls="collapse${b.board_no}">
                    <span class="badge badge-primary mr-2">${b.faq_category}</span>
                    Q. ${b.title}
                </button>
        ...
        <div id="collapse${b.board_no}" class="collapse"
             aria-labelledby="heading${b.board_no}"
...
<div class="text-right mb-3 mt-4">
    <button class="btn btn-primary" onclick="showFaqWriteForm(${page}); return false;">글쓰기</button>
</div>
