				...
				<nav class="category-sidebar">
					...
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a href="selectSoup" class="nav-link">국
								．밥 ．면</a></li>
						<li class="nav-item"><a href="selectDiet"
							class="nav-link active">식단관리</a></li>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right"
									...
									<a class="dropdown-item"
										href="selectDiet?page=1&size=${size}&q=${fn:escapeXml(q)}">최신순</a>
									<a class="dropdown-item"
										href="selectDiet?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_desc">가격
										높은순</a> <a class="dropdown-item"
										href="selectDiet?page=1&size=${size}&q=${fn:escapeXml(q)}&sort=price_asc">가격
										낮은순</a>
								</div>
							</div>
						</div>
						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center mb-3">
								<li class="page-item ${page <= 1 ? 'disabled' : ''}"><a
									class="page-link"
									href="selectDiet?page=${page-1}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}"
								...
								<c:forEach var="i" begin="1" end="${totalPages}">
									<li class="page-item ${i == page ? 'active' : ''}"><a
										class="page-link"
										href="selectDiet?page=${i}&size=${size}&q=${fn:escapeXml(q)}&sort=${sort}">${i}</a>
									</li>
								</c:forEach>
