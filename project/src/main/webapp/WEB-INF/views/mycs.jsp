		...
		<div class="row px-xl-5">
			...
			<div class="col-lg-10" style="margin-top: 30px; margin-bottom: 50px;">
				<div class="text-center mb-4">
					<h4>취소·반품·교환내역</h4>
					<form>
						<button style="margin-left:850px;">취소·반품·교환신청</button>
					</form>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row mb-3">
						...
						<div class="col-md-6">
							<strong>신청유형:</strong> <span class="badge badge-warning"style="background-color:#EDF1FF; color: black;">반품</span>
						</div>
					</div>
					<div class="row mb-3">
						<div class="col-md-12">
							<strong>상태:</strong> <span class="badge badge-info"style="background-color:#EDF1FF; color: black;">처리중</span>
						</div>
					</div>
					<hr>
					<div class="row mb-3">
