		...
		<div class="row border-top px-xl-5">
			<div class="col-lg-3 d-none d-lg-block">
				<a
					...
					style="height: 65px; margin-top: -1px; padding: 0 30px;"> <span
					class="m-0">마이 페이지</span> <i class="fa fa-angle-down text-dark"></i>
				</a>
				<nav
					class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light"
					id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
					<div class="navbar-nav w-100 overflow-hidden" style="height: 325px">
						<a href="#" class="nav-item nav-link">주문내역보기 </a> <a href="#"
							class="nav-item nav-link">취소/반품/교환내역보기 </a> <a href="#"
							class="nav-item nav-link">1:1 문의내역보기</a>
					</div>
				</nav>
			</div>
				<div class="container">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							...
							<td>10,000원</td>
							<td>주문요청 중</td>
							<td><button class="btn btn-sm btn-secondary">상세보기</button></td>
						</tr>
					</tbody>
				</table>
			</div>
