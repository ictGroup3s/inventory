...
<body>
	...
	<div class="container complete-container">
		<div class="complete-box">
			...
			<div class="btn-group">
				...
				<a href="/orderhistory" class="btn btn-custom btn-order">
	...
	<!-- Footer Start -->
	<div class="container-fluid bg-secondary text-dark mt-5 pt-5" style="margin-top: 100px !important;">
			...
			<div class="col-lg-8 col-md-12">
				<div class="row">
					...
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-dark mb-2" href="/orderhistory"><i class="fa fa-angle-right mr-2"></i>주문내역</a>
							<a class="text-dark mb-2" href="/cs"><i class="fa fa-angle-right mr-2"></i>취소/반품/교환</a>
							<a class="text-dark" href="/myqna"><i class="fa fa-angle-right mr-2"></i>1:1문의</a>
						</div>
					</div>
					<div class="col-md-4 mb-5">
